...
extension Requestable {
    ...
    func urlRequest(with config: NetworkConfigurable) throws -> URLRequest {
        ...
        var allToken: [String: String] = config.tokenParameters
        headerParameters.forEach { allHeaders.updateValue($1, forKey: $0) }
        headerParameters.forEach { allToken.updateValue($1, forKey: $0) }

        //headerParameters["Authorization"] = "Bearer \(accessToken.token)"
